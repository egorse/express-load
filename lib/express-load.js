...
/**
 *  From method - store path prefix
 *  Used by @__getEntity and @getName
 * 
 *  @param directory {String} Directory to load from.
 *  @return this {Object} this ExpressLoad instance.
 */
ExpressLoad.prototype.from = function(directory) {
    this.cwd = directory;
    return this;
};
 ...
 *  Load method - alias to then 
 *
 *  @param location {String} Directory/file to load.
 *  @return this {Object} this ExpressLoad instance.
 */

ExpressLoad.prototype.load =
...
ExpressLoad.prototype.__getEntity = function(location) {
  ...
  var entity = this.cwd ? 
    path.resolve(
      path.normalize(path.join(this.cwd, location))
    ):
    path.resolve(
...
/**
 * ExpressLoad alias constructor.
 * 
 * Purpose is more nicer use if method from
 * i.e.:
...
module.exports.from = function(directory, options) {
    var load = new ExpressLoad(undefined, options);
